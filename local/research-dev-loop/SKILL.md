...
Use RDL as a write-through evidence record, not a project supervisor. The CLI owns normalized state and renders the files under `.rdl/`; treat those files as inspectable views and submit changes with `rdl apply`.
