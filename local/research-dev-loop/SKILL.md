...
Rounds are material decisions; routine applies stay in-round. Resolve this skill's absolute `bin/rdl` as `RDL`; mutate only through `"$RDL" apply`. See [CLI.md](CLI.md).
