...
1. Run `rdl review --for next|close`. Give the returned pack to a fresh-context independent reviewer. Completion: it returns the exact action and subject digest, an adapter name, a verdict, and concise findings.
